...
export default class News extends Component {
  ...
  fetchMoreData = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5deb2b3fc6bb42b6a4d5d191d458a8dd&page=${nextPage}&pageSize=${this.props.pageSize}`;
